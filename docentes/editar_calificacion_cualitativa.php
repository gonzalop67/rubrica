<?php
	...
	$rubricas_evaluacion->re_calificacion = $_POST["rc_calificacion"];
	if (!$rubricas_evaluacion->existeRubricaCualitativa())
		echo $rubricas_evaluacion->insertarRubricaCualitativa();
	else
		echo $rubricas_evaluacion->actualizarRubricaCualitativa();
?>
