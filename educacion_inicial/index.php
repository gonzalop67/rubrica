<div class="container">
        <div id="div_menus" class="col-sm-10 col-sm-offset-1">
            <h2>Ámbitos Escolares</h2>
            <input type="hidden" id="id_ambito_escolar">
            <!-- panel -->
            <div class="panel panel-default">
                <form id="form_ambitos" action="" class="app-form">
        ...
        <div id="div_subambitos" class="col-sm-10 col-sm-offset-1">
            <h2>SubÁmbitos</h2>
            <!-- panel -->
            <div class="panel panel-default">
                <form id="form_subambitos" action="" class="app-form">
                    <button id="btn-new-subambito" type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#addNewSubambito">
                        Nuevo SubÁmbito
                    </button>
                </form>
                <!-- message -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-center" id="myModalLabel1">Nuevo Ámbito</h4>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-center" id="myModalLabel2">Nuevo Sub Men&uacute;</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-2">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-center" id="myModalLabel3">Editar Men&uacute;</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-2">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-center" id="myModalLabel4">Editar Sub Men&uacute;</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-2">
