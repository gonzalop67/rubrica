<?php
	...
	if (!$rubricas_evaluacion->existeRubricaEstudiante() && $rubricas_evaluacion->re_calificacion != 0) {
		echo $rubricas_evaluacion->insertarRubricaEstudiante();
	} else if ($rubricas_evaluacion->re_calificacion == 0) {
		echo $rubricas_evaluacion->eliminarRubricaEstudiante();
	} else {
