...
<head>
    ...
    <title>SIAE-WEB Registro de Asistencia Estudiantil</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="admin.php?id_usuario=<?php echo $id_usuario ?>&enlace=dashboard.php" class="logo">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    ?>
                    <!-- <li class="<?php echo $active1 ?>"><a href="admin2.php?id_usuario=<?php echo $id_usuario ?>&enlace=dashboard.php"><i class="fa fa-home"></i> <span>Dashboard</span></a></li> -->
