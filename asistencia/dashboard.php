<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            ?>
                <a href="admin2.php?id_usuario=<?php echo $id_usuario ?>&enlace=registrar_asistencia.php&id_curso=<?php echo $id_curso ?>&id_paralelo=<?php echo $id_paralelo ?>&id_asignatura=<?php echo $id_asignatura ?>&nombre=<?php echo $nombre ?>&curso=<?php echo $curso ?>&id_periodo_lectivo=<?php echo $id_periodo_lectivo ?>">
