...
<html>
    <head>
        ...
        <link href="<?= RUTA_URL ?>/public/assets/Annex/plugins/morris/morris.css" rel="stylesheet">
    ...
    <body class="fixed-left">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-2.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                            <p class="notify-details"><b>Charles M. Jones</b><small class="text-muted">Dummy text of the printing and typesetting industry.</small></p>
                                        </a>

                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-3.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                                            <p class="notify-details"><b>Thomas J. Mimms</b><small class="text-muted">You have 87 unread messages</small></p>
                                        </a>

                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-4.jpg" alt="user-img" class="img-fluid rounded-circle" /> </div>
                    ...
                    <div class="page-content-wrapper ">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-12 col-xl-4">
                                    <div class="card bg-white m-b-30">
                                        <img src="<?= RUTA_URL ?>/public/assets/Annex/images/widgets/wather.jpg" alt="" class="img-fluid">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img class="rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-2.jpg" alt="user" width="40"> </td>
                                                            <td>
                                                                <a href="javascript:void(0);">Ruby T. Curd</a>
                                                            </td>
                                                            <td>                                                                
                                                                <img src="<?= RUTA_URL ?>/public/assets/Annex/images/flags/us_flag.jpg" alt="" style="width:30px">
                                                            </td>
                                                            <td>$100</td>
                                                            <td>10</td>                                   
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img class="rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-3.jpg" alt="user" width="40"> </td>
                                                            <td>
                                                                <a href="javascript:void(0);">William A. Johnson</a>
                                                            </td>
                                                            <td>                                                                
                                                                <img src="<?= RUTA_URL ?>/public/assets/Annex/images/flags/french_flag.jpg" alt="" style="width:30px">
                                                            </td>
                                                            <td>$490</td>
                                                            <td>24</td>                                   
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img class="rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-4.jpg" alt="user" width="40"> </td>
                                                            <td>
                                                                <a href="javascript:void(0);">Bobby M. Gray</a>
                                                            </td>
                                                            <td>                                                                
                                                                <img src="<?= RUTA_URL ?>/public/assets/Annex/images/flags/spain_flag.jpg" alt="" style="width:30px">
                                                            </td>
                                                            <td>$380</td>
                                                            <td>19</td>                                   
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img class="rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-5.jpg" alt="user" width="40"> </td>
                                                            <td>
                                                                <a href="javascript:void(0);">Robert N. Carlile</a>
                                                            </td>
                                                            <td>                                                                
                                                                <img src="<?= RUTA_URL ?>/public/assets/Annex/images/flags/russia_flag.jpg" alt="" style="width:30px">
                                                            </td>
                                                            <td>$450</td>
                                                            <td>30</td>                                   
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <img class="rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-6.jpg" alt="user" width="40"> </td>
                                                            <td>
                                                                <a href="javascript:void(0);">Ruby T. Curd</a>
                                                            </td>
                                                            <td>                                                                
                                                                <img src="<?= RUTA_URL ?>/public/assets/Annex/images/flags/italy_flag.jpg" alt="" style="width:30px">
                                                            </td>
                                                            <td>$500</td>
                                                            <td>40</td>                                   
                                                            <td>
                                            ...
                                            <ul class="list-unstyled mb-0 pr-3" id="boxscroll2" tabindex="1" style="overflow: hidden; outline: none;">
                                                <li class="p-3">
                                                    <div class="media">
                                                        <div class="thumb float-left">
                                                            <a href="#">
                                                                <img class=" rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-5.jpg" alt="">
                                                            </a>
                                                        </div>
                                                ...
                                                <li class="p-3">
                                                    <div class="media">
                                                        <div class="thumb float-left">
                                                            <a href="#">
                                                                <img class=" rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-4.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
                                                ...
                                                <li class="p-3">
                                                    <div class="media">
                                                        <div class="thumb float-left">
                                                            <a href="#">
                                                                <img class=" rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-3.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">                                                    
                                                ...
                                                <li class="p-3">
                                                    <div class="media">
                                                        <div class="thumb float-left">
                                                            <a href="#">
                                                                <img class=" rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-2.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
                                                ...
                                                <li class="p-3">
                                                    <div class="media">
                                                        <div class="thumb float-left">
                                                            <a href="#">
                                                                <img class=" rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-1.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
                                                ...
                                                <li class="p-3">
                                                    <div class="media">
                                                        <div class="thumb float-left">
                                                            <a href="#">
                                                                <img class=" rounded-circle" src="<?= RUTA_URL ?>/public/assets/Annex/images/users/avatar-6.jpg" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="media-body">
        ...
        <script src="<?= RUTA_URL ?>/public/assets/Annex/plugins/skycons/skycons.min.js"></script>
        <script src="<?= RUTA_URL ?>/public/assets/Annex/plugins/raphael/raphael-min.js"></script>
        <script src="<?= RUTA_URL ?>/public/assets/Annex/plugins/morris/morris.min.js"></script>
        
        <script src="<?= RUTA_URL ?>/public/assets/Annex/pages/dashborad.js"></script>
