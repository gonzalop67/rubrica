            ...
            <form id="form_insert" onsubmit="return insertarCategoria()" autocomplete="off">
                <div class="modal-body fuente10">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control mayusculas" id="category" name="category" value="" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control mayusculas" id="exam_time_in_minutes" name="exam_time_in_minutes" value="" required>
