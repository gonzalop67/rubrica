        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12 table-responsive">
                    <a class="btn btn-primary" href="<?php echo RUTA_URL; ?>/paralelos/create"><i class="fa fa-plus-circle"></i> Nuevo Registro</a>
                    <hr>
                            ...
                            ?>
                                <?php foreach ($datos['paralelos'] as $v) : ?>
                                    <tr data-index="<?= $v->id_paralelo ?>" data-orden="<?= $v->pa_orden ?>">
                                        ...
                                        <td><?= $v->jo_nombre ?></td>
                                        <td>
                                            <a href="<?php echo RUTA_URL; ?>/paralelos/edit/<?php echo $v->id_paralelo; ?>" class="btn btn-warning" title="Editar"><span class="fa fa-pencil"></span></a>
                                            <a href="<?php echo RUTA_URL; ?>/paralelos/delete/<?php echo $v->id_paralelo; ?>" class="btn btn-danger item-delete" title="Eliminar"><span class="fa fa-trash"></span></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            <?php } else { ?>
                                <tr class="text-center">
                                    <td colspan="7">Aún no se han ingresado paralelos...</td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
...
<script>
    ...
    function saveNewPositions() {
        ...
        $.ajax({
            url: "<?php echo RUTA_URL; ?>/paralelos/saveNewPositions",
            method: 'POST',
            dataType: 'text',
            data: {
                positions: positions
            ...
            success: function(response) {
                ...
                window.location.href = "<?php echo RUTA_URL; ?>/paralelos";
            }
        });
    }
</script>