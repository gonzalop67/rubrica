...
<section class="content">
    <div class="box box-info">
        ...
        <!-- form start -->
        <div class="box-body">
            <form id="form-paralelo-inspector" action="" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control fuente10" name="id_usuario" id="id_usuario" required>
                            <option value="">Seleccione...</option>
                            <?php foreach ($datos['inspectores'] as $v) : ?>
...
<script>
    $(document).ready(function() {
        ...
        $("#form-paralelo-inspector").submit(function(e) {
            e.preventDefault();
            ...
            if (id_paralelo !== "" && id_usuario !== "") {
                ...
                $.ajax({
                    url: "<?php echo RUTA_URL; ?>/paralelos_inspectores/insert",
                    method: "post",
                    data: {
        ...
        $('#lista_items').on('click', '.item-delete', function(e) {
            ...
            $("#text_message").html("<img src='<?php echo RUTA_URL; ?>/public/img/ajax-loader-blue.GIF' alt='procesando...' />");
            $.ajax({
                url: "<?php echo RUTA_URL; ?>/paralelos_inspectores/delete",
                method: "post",
                data: {
                    id: id
                },
    ...
    function cargar_paralelos_inspectores() {
        var request = $.ajax({
            url: "<?php echo RUTA_URL; ?>/paralelos_inspectores/listar",
            method: "get",
            dataType: "json"
        });
