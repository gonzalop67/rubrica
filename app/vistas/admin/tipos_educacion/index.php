        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12 table-responsive">
                    <a class="btn btn-primary" href="<?php echo RUTA_URL; ?>/tipos_educacion/create"><i class="fa fa-plus-circle"></i> Nuevo Registro</a>
                    <hr>
                    ...
                    <table id="t_tipos_educacion" class="table table-striped table-hover">
                        ...
                        <tbody id="tbody_tipos_educacion">
                            <?php foreach ($datos['tipos_educacion'] as $v) : ?>
                                <tr data-index="<?= $v->id_nivel_educacion ?>" data-orden="<?= $v->orden ?>">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="<?php echo RUTA_URL; ?>/tipos_educacion/delete/<?php echo $v->id_nivel_educacion; ?>" class="btn btn-danger item-delete" title="Eliminar"><span class="fa fa-trash"></span></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach ?>
