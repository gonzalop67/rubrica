            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel-body">
                        ...
                        <form id="frm-especialidad" action="<?php echo RUTA_URL; ?>/especialidades/store" method="post">
                            <div class="form-group">
                                <label for="es_nombre" class="control-label">Nombre:</label>
                                <input type="text" name="es_nombre" id="es_nombre" value="" class="form-control" autofocus required>
                            </div>
                            <div class="form-group">
                                <label for="es_figura" class="control-label">Figura Profesional:</label>
                                <input type="text" name="es_figura" id="es_figura" value="" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="es_abreviatura" class="control-label">Abreviatura:</label>
                                <input type="text" name="es_abreviatura" id="es_abreviatura" value="" class="form-control" required>
                            </div>
                            <div class="form-group">
