        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form id="frm-escalas-calificaciones" action="<?php echo RUTA_URL; ?>/escalas_calificaciones/update" method="post" autocomplete="off">
                        <input type="hidden" name="id_escala_calificaciones" id="id_escala_calificaciones" value="<?= $datos['escalaCalificacion']->id_escala_calificaciones ?>">
                        <div class="form-group">
                            <label for="ec_cualitativa" class="control-label requerido">Escala Cualitativa:</label>
                            <input type="text" name="ec_cualitativa" id="ec_cualitativa" value="<?= $datos['escalaCalificacion']->ec_cualitativa ?>" class="form-control" autofocus required>
                        </div>
                        <div class="form-group">
                            <label for="ec_cuantitativa" class="control-label requerido">Escala Cuantitativa:</label>

                            <input type="text" name="ec_cuantitativa" id="ec_cuantitativa" value="<?= $datos['escalaCalificacion']->ec_cuantitativa ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="ec_nota_minima" class="control-label requerido">Nota Mínima:</label>

                            <input type="number" step="any" min="0" max="10" name="ec_nota_minima" id="ec_nota_minima" value="<?= $datos['escalaCalificacion']->ec_nota_minima ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="ec_nota_maxima" class="control-label requerido">Nota Máxima:</label>

                            <input type="number" step="any" min="0" max="10" name="ec_nota_maxima" id="ec_nota_maxima" value="<?= $datos['escalaCalificacion']->ec_nota_maxima ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="ec_equivalencia" class="control-label requerido">Equivalencia:</label>

                            <input type="text" name="ec_equivalencia" id="ec_equivalencia" value="<?= $datos['escalaCalificacion']->ec_equivalencia ?>" class="form-control" required>
                        </div>
                        <div class="form-group">
