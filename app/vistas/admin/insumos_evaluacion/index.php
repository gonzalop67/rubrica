        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12 table-responsive">
                    <a class="btn btn-primary" href="<?php echo RUTA_URL; ?>/insumos_evaluacion/create"><i class="fa fa-plus-circle"></i> Nuevo Registro</a>
                    <hr>
                    ...
                    <table id="t_insumos_evaluacion" class="table table-striped table-hover">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Periodo</th>
                        ...
                        <tbody id="tbody_insumos_evaluacion">
                            <?php
                            if (count($datos['insumos_evaluacion']) > 0) {
                            ?>
                                <?php foreach ($datos['insumos_evaluacion'] as $v) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?php echo RUTA_URL; ?>/insumos_evaluacion/edit/<?php echo $v->id_rubrica_evaluacion; ?>" class="btn btn-warning" title="Editar"><span class="fa fa-pencil"></span></a>
                                                <a href="<?php echo RUTA_URL; ?>/insumos_evaluacion/delete/<?php echo $v->id_rubrica_evaluacion; ?>" class="btn btn-danger item-delete" title="Eliminar"><span class="fa fa-trash"></span></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            <?php } else { ?>
                                <tr class="text-center">
                                    <td colspan="5">Aún no se han ingresado insumos de evaluación...</td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
