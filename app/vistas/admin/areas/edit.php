            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel-body">
                        ...
                        <form id="frm-area" action="<?php echo RUTA_URL; ?>/areas/update" method="post">
                            <input type="hidden" name="id_area" id="id_area" value="<?= $datos['area']->id_area ?>">
                            <div class="form-group">
                                <label for="ar_nombre">Nombre:</label>
                                <input type="text" name="ar_nombre" id="ar_nombre" value="<?= $datos['area']->ar_nombre ?>" class="form-control" autofocus required>
                            </div>
                            <div class="form-group">
                                <button id="btn-save" type="submit" class="btn btn-warning"><i class="fa fa-pencil"></i> Actualizar</button>
                                <a href="<?php echo RUTA_URL; ?>/areas" class="btn btn-default"><i class="fa fa-backward"></i> Volver</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        Biblioteca.validacionGeneral('frm-area');
    });
</script>