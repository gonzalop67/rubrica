...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo RUTA_URL ?>/assets/template/Ionicons/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo RUTA_URL ?>/assets/template/dist/css/AdminLTE.css">
  <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect. -->
  <link rel="stylesheet" href="<?php echo RUTA_URL ?>/assets/template/dist/css/skins/_all-skins.min.css">
...
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo RUTA_URL ?>/assets/template/bootstrap/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo RUTA_URL ?>/assets/template/dist/js/adminlte.min.js"></script>
