...
$db = new MySQL();
$estudiantes = $db->consulta("SELECT e.id_estudiante, es_cedula, es_apellidos, es_nombres, es_retirado, nro_matricula FROM sw_estudiante e, sw_estudiante_periodo_lectivo p WHERE e.id_estudiante = p.id_estudiante AND p.id_paralelo = $id_paralelo AND activo = 1 ORDER BY es_apellidos, es_nombres");
...
$filename = "PADRON ELECTORAL DE " . str_replace('"', '', $nombreParalelo) . " " . $nombrePeriodoLectivo . ".xls";
