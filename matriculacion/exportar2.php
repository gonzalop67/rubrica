        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <div style="margin-top: 10px;">
                    <form id="form_id" action="matriculacion/exportar_excel.php" method="POST" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <button type="submit" id="export_excel" name="export" class="btn btn-info btn-sm ocultar"><i class="fa fa-download"></i> Exportar a EXCEL</button>
                            </div>
                        </div>
                    </form>
                </div>
