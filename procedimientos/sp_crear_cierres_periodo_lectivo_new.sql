...
BEGIN
  ...
  SELECT id_paralelo
    ...
    WHERE p.id_curso = c.id_curso 
      ...
      AND e.id_nivel_educacion = n.id_nivel_educacion 
      AND n.id_nivel_educacion = pn.id_nivel_educacion  
      AND pn.id_periodo_lectivo = IdPeriodoLectivo;
    ...
    INNER_BLOCK: BEGIN
      ...
      SELECT a.id_aporte_evaluacion
        ...
        WHERE sp.id_sub_periodo_evaluacion = a.id_sub_periodo_evaluacion
          ...
          AND ps.id_periodo_lectivo = IdPeriodoLectivo;
