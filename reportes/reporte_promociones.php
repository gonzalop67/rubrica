<?php
	...
	class PDF extends FPDF
	{
		...
		function Header()
		{
			...
			$title2="CERTIFICADO DE PROMOCI�N";
			...
			$txt = "De conformidad con lo prescrito en el Art. 197 del Reglamento a la Ley Org�nica de Educaci�n Intercultural y dem�s normativas vigentes certifica que el/la estudiante:";
		...
		function Footer()
		{
			...
			$this->Cell(185,6,"Espacio para legalizaci�n","LTR",1,"C");
	...
	if($num_total_registros>0)
	{
		...
		while($paralelo = $db->fetch_assoc($consulta))
		{
			...
			if($tipoEducacion==1) // Se trata de bachillerato
				$txt = "Del " . utf8_decode($nombreParalelo) . "; FIGURA PROFESIONAL: " . utf8_decode($nombreFiguraProfesional) . ", obtuvo las siguientes calificaciones durante el a�o lectivo " . $nombrePeriodoLectivo . ".";
			else
				$txt = "De " . utf8_decode($nombreParalelo) . " de " . utf8_decode($nombreFiguraProfesional) . ", obtuvo las siguientes calificaciones durante el a�o lectivo " . $nombrePeriodoLectivo . ".";
