<?php
	...
	set_time_limit(0); // Para procesos muy grandes que requieren mayor tiempo de conexi�n
		...
		while($paralelo = $db->fetch_assoc($consulta))
		{
			...
			{ 
				...
				{ 
				    ...
				    $pdf->Cell(13,6,number_format($promedio_aporte,2),1,0,'C');
					$suma_asignaturas += $promedio_aporte;
				}
				...
				if($promedio_asignaturas > 0) $calificaciones_validas++;
			}
