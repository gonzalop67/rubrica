<?php
	...
	$pdf->Cell(18,6,"1ER.P.",1,0,'C');
    $pdf->Cell(18,6,"2DO.P.",1,0,'C');
    $pdf->Cell(18,6,"3ER.P.",1,0,'C');
	...
	if($num_total_registros>0)
	{
		...
		while($paralelo = $db->fetch_assoc($consulta))
		{
			...
			while($aporte_evaluacion = $db->fetch_assoc($aportes_evaluacion))
			{
                ...
                $query = $db->consulta("SELECT ec_equivalencia FROM sw_escala_comportamiento WHERE ec_correlativa = $promedio_cuantitativo");
