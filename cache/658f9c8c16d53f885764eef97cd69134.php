                    ...
                    <form id="formulario" action="" enctype="multipart/form-data" method="post">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-4">
                                <select name="tipo_documento" id="tipo_documento" class="form-control">
                                    ...
                                    <option value="<?php echo htmlspecialchars((string)($tipo_documento['id_tipo_documento']), ENT_QUOTES, "UTF-8"); ?>"><?php echo htmlspecialchars((string)($tipo_documento['td_nombre']), ENT_QUOTES, "UTF-8"); ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                <select name="nacionalidad" id="nacionalidad" class="form-control">
                                    ...
                                    <option value="<?php echo htmlspecialchars((string)($nacionalidad['id_def_nacionalidad']), ENT_QUOTES, "UTF-8"); ?>"><?php echo htmlspecialchars((string)($nacionalidad['dn_nombre']), ENT_QUOTES, "UTF-8"); ?></option>
                                    <?php endforeach; ?>
                                </select>
                                <div id="error-genero" class="invalid-feedback" style="display:none;"></div>
                            </div>
                        ...
                        <div id="roles-container" class="row mb-2">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div>
                                    <input type="checkbox" name="roles[]" value="<?php echo htmlspecialchars((string)($role['id_perfil']), ENT_QUOTES, "UTF-8"); ?>">
                                    <?php echo htmlspecialchars((string)($role['pe_nombre']), ENT_QUOTES, "UTF-8"); ?>
                                </div>
                                <?php endforeach; ?>
                        ...
                        <div class="row mb-2">
                            ...
                            <div id="img_div" class="col-sm-10">
                                <img id="us_avatar" src="<?php echo htmlspecialchars((string)(RUTA_URL), ENT_QUOTES, "UTF-8"); ?>/public/img/vecteezy_blue-profile-icon_36885313.png" name="us_avatar" class="img-thumbnail" width="75" alt="Avatar del usuario">
                            </div>
                        </div>
                        <div class="row mb-2">
