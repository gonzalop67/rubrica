...
<div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="myModalNew" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalNew">Nueva Especialidad</h4>
            </div>
...
<div class="modal fade" id="editEspecialidad" tabindex="-1" role="dialog" aria-labelledby="myModalEdit" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title text-center" id="myModalEdit">Editar Especialidad</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-2">
