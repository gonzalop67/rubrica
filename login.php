	...
	$(document).ready(function(){
		...
		*/
		$(window).bind("capsOn", function(event) {
			...
			$("#statetext").html("Bloq Mayús Activado");
			$("#capslock").show();
		});
		$(window).bind("capsOff", function(event) {
			//$("#statetext").css("color","black");
			//$("#statetext").html("Desactivado");
			$("#capslock").hide();
		});
		$(window).bind("capsUnknown", function(event) {
			$("#statetext").css("color","black");
			$("#statetext").html("Desconocido");
		});
		...
		*/
		...
		// Este codigo es para validar la entrada de los datos
		$('#login-form').submit(function(e) {
			...
			if(login.length==0)
			{
				var mensaje = "El nombre del usuario es obligatorio";
				$("#mensaje").html(mensaje);
				document.getElementById("uname").focus();
			}
			else if(passwd.length==0)
			{
				var mensaje = "La clave del usuario es obligatoria";
				$("#mensaje").html(mensaje);
			...
			else
			{
				...
				$.post("scripts/verificar_login.php", $(this).serialize(), function(resp) {
					...
					if (!resp.error) {
                        ...
                        location.href = "admin_index.php?id_usuario=" + resp['id_usuario'] + "&id_perfil=" + id_perfil;
                      ...
                      <table id="tabla_login" width="100%" cellpadding="0" cellspacing="0" border="0">
                         <tr>
                            ...
                            <td width="*" align="right">
                              <div class="botones">
                                  <a href="index.php">
                                    <img src="imagenes/login_gnome.png" onmouseover="this.src='imagenes/login_gnome1.png'" onmouseout="this.src='imagenes/login_gnome.png'" alt="haga click para ir a la pagina principal..." title="Ir al Inicio..." />
                                  </a>
                              </div>
                            </td>  
                         </tr>
                        ...
                        <td style="color:#666666;" >
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr id="div_usuario">
                                    ...
                                    <td>
                                        <input type="text" class="inputGrande"  maxlength="40" name="uname" id="uname" />
                                        <div id="mensaje1"></div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr id="capslock">
                                    <td align="right"><img src="imagenes/spacer.gif" border="0" width="50" height="1" alt="" />Aviso:&nbsp;</td>
                                    <td><div id="statetext"></td>
                                </tr>
                                <tr>
