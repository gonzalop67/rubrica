...
class respuestas extends MySQL
{
	...
	function insertarRespuesta()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo insertar la respuesta...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function actualizarTema()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo actualizar el tema...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function eliminarTema()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo eliminar el tema...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
