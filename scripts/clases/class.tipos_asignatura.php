...
class tipos_asignatura extends MySQL
{
	...
	function insertarTipoAsignatura()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo insertar el Tipo de Asignatura...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function actualizarTipoAsignatura()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo actualizar el Tipo de Asignatura...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function eliminarTipoAsignatura()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo eliminar el Tipo de Asignatura...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
