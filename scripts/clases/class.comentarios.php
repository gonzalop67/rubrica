...
class comentarios extends MySQL
{
	...
	{
		// Funcion que retorna todos los comentarios ingresados en la base de datos
		$consulta = parent::consulta("SELECT co_nombre AS usuario, co_texto, DATE_FORMAT(co_fecha,'%Y-%m-%d') AS fecha FROM sw_comentario ORDER BY co_fecha DESC");
	...
	function insertarComentario()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo insertar el comentario...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		return $mensaje;
	}
	...
	function eliminarComentario()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo eliminar el usuario...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
}
?>