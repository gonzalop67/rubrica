...
class clubes extends MySQL
{
	...
	function insertarClub()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo insertar el Club...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function actualizarClub()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo actualizar el Club...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function eliminarClub()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo eliminar el Club...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function asociarClubDocente()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo asociar el Club...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function eliminarClubDocente()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo des-asociar el Docente...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}	
