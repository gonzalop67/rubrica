...
class foros extends MySQL
{
	...
	function insertarForo()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo insertar el foro...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function actualizarForo()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo actualizar el foro...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
	...
	function eliminarforo()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo eliminar el foro...Error: " . mysqli_error($this->conexion);
		return $mensaje;
	}
