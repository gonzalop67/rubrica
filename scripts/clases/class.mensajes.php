...
class mensajes extends MySQL
{
	...
	function insertarMensaje()
	{
		...
		if (!$consulta){
			$respuesta = "ERROR";
			$mensaje = "No se pudo insertar el mensaje...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		}
	...
	function actualizarMensaje()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo actualizar el mensaje...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		return $mensaje;
	}
	...
	function eliminarMensaje()
	{
		...
		if (!$consulta)
			$mensaje = "No se pudo eliminar el mensaje...Error: " . mysqli_error($this->conexion);
		return $mensaje; */
	}
}
?>