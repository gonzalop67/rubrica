...
class recomendaciones extends MySQL
{
	...
	function editarRecomendacionesQuimestrales($id_escala_calificaciones,$id_paralelo_asignatura,$id_periodo_evaluacion)
	{
		if (!$this->existeRecomendacionesQuimestrales($id_escala_calificaciones,$id_paralelo_asignatura,$id_periodo_evaluacion)) {
			...
			if (!$consulta)
				$mensaje = "No se pudieron insertar las recomendaciones quimestrales...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		} else {
			...
			if (!$consulta)
				$mensaje = "No se pudieron actualizar las recomendaciones quimestrales...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		}
	...
	function editarPlanMejoraAnual($id_escala_calificaciones,$id_paralelo_asignatura)
	{
		if (!$this->existeRecomendacionesAnuales($id_escala_calificaciones,$id_paralelo_asignatura)) {
			...
			if (!$consulta)
				$mensaje = "No se pudieron insertar las recomendaciones anuales...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		} else {
			...
			if (!$consulta)
				$mensaje = "No se pudieron actualizar las recomendaciones anuales...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		}
		return $mensaje;
	}
	...
	function editarRecomendaciones($id_escala_calificaciones,$id_paralelo_asignatura,$id_aporte_evaluacion)
	{
		if (!$this->existeRecomendaciones($id_escala_calificaciones,$id_paralelo_asignatura,$id_aporte_evaluacion)) {
			...
			if (!$consulta)
				$mensaje = "No se pudo insertar las recomendaciones...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		} else {
			...
			if (!$consulta)
				$mensaje = "No se pudo actualizar las recomendaciones...Error: " . mysqli_error($this->conexion) . "<br />Consulta: " . $qry;
		}
		return $mensaje;
	}
}
