    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">Nueva R&uacute;brica de Evaluaci&oacute;n</h4>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">Editar R&uacute;brica de Evaluaci&oacute;n</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-2">
