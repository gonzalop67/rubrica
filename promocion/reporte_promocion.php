...
if($tipoEducacion==1) // Se trata de bachillerato
	$txt = "del " . $nombreParalelo . "; FIGURA PROFESIONAL: " . $nombreFiguraProfesional . ", obtuvo las siguientes calificaciones durante el presente " . utf8_encode("a�o") . " lectivo.";
else // Se trata de Educaci�n B�sica Superior
	$txt = "del " . $nombreParalelo . " DE " . $nombreFiguraProfesional . ", obtuvo las siguientes calificaciones durante el presente " . utf8_encode("a�o") . " lectivo.";
	
// Primero busco la plantilla adecuada de acuerdo al tipo de educaci�n => 0: Educaci�n B�sica Superior  1: Bachillerato
...
$objPHPExcel->getActiveSheet()->setCellValue('C2', $nombreInstitucion)
							  ->setCellValue('C4', utf8_encode('A�O LECTIVO '.$nombrePeriodoLectivo))
