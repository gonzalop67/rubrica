    ...
    <script>
        ...
        function subirNivelEducacion(id_tipo_educacion)
        {
            if (id_tipo_educacion == "") {
                document.getElementById("text_message").innerHTML = "No se ha pasado correctamente el par&aacute;metro id_tipo_educacion...";
            } else {
                $("#text_message").html("<img src='imagenes/ajax-loader.gif' alt='procesando...' />");
                $.ajax({
                        type: "POST",
                        url: "tipo_educacion/subir_tipo_educacion.php",
                        data: {
        ...
        function bajarNivelEducacion(id_tipo_educacion)
        {
            if (id_tipo_educacion == "") {
                document.getElementById("text_message").innerHTML = "No se ha pasado correctamente el par&aacute;metro id_tipo_educacion...";
            } else {
                ...
                $.ajax({
                        type: "POST",
                        url: "tipo_educacion/bajar_tipo_educacion.php",
                        data: {
                            id_tipo_educacion: id_tipo_educacion
                        },
                        success: function(resultado){
