...
<body>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-center" id="myModalLabel">Nuevo Aporte de Evaluaci&oacute;n</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <label class="control-label" style="position:relative; top:7px;">F. Inicial:</label>
                        </div>
                        <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-2">
                            <label class="control-label" style="position:relative; top:7px;">F. Final:</label>
                        </div>
                        <div class="col-lg-10">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-center" id="myModalLabel">Editar Aporte de Evaluaci&oacute;n</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-2">
    ...
    <script>
        ...
        function editApoEval(id){
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    setearIndice("edit_ap_tipo",aporte.ap_tipo);
        ...
        function addApoEval(){
            ...
            var ap_fecha_apertura = $("#new_ap_fecha_apertura").val();
            var ap_fecha_cierre = $("#new_ap_fecha_cierre").val();
            $.ajax({
